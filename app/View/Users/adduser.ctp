...
<tbody>
	...
	<tr>
		...
		<td class='user_personal_info' rowspan=6>
			...
			echo $this->Form->textarea('bio', array('placeholder' => 'Bio', 'class' => 'editor1', 'label' => 'Bio')).'<br>';
			echo $this->Form->input('avtar', array('type' => 'hidden', 'id' => 'avtar')).'<br>';
			?>
			<a class="UploadButton" id="UploadButton">
			<input type="file" name="UploadButton"></a>
			...
			<!--hidden company ID-->
			<input type="hidden" id="company_id" name="User[company_id]" value="<?php echo $this->Session->read('Auth.User.company_id');?>"/>
	...
	<tr></tr>
	<tr>
		<td><?php echo $this->Form->input('group_id', array('type' => 'select','options'=>$groups)); ?>
