			...
			onSelect: function(){
				$.ajax({
					...
					success: function(data){
						...
						$('#Quarter0StartDate').val(str[0]); $('#Quarter0EndDate').val(str[1]);
						$('#Quarter1StartDate').val(str[1]); $('#Quarter1EndDate').val(str[2]);
						$('#Quarter2StartDate').val(str[2]); $('#Quarter2EndDate').val(str[3]);
						$('#Quarter3StartDate').val(str[3]); $('#Quarter3EndDate').val(str[4]);
					}
